...
<article class="prose">
  ...
  <h2>Who</h2>
  <p>Joe Eichenbaum. I'm a partner at a small consulting firm that works with state and local governments, and I build things on the side. The code is open; the site costs almost nothing to run, so it will stay free. Corrections, complaints, and ideas: <a href="mailto:${esc("joe@group17a.com")}">joe@group17a.com</a>.</p>
</article>`;
