...
<article class="prose">
  ...
  <ul>
    ...
    <li><strong>The shape of the page, drawn by the same AI.</strong> A page of Talmud does not mark its own joints: a question, a proof, an objection and a story run on without headings. The map cuts the page into its moves, points each at the lines it covers, and says in one sentence how the whole page runs. It is labelled as AI, it can be folded away, and as you read, a line at the top says where you are.</li>
  ...
  <p>The map is made the same way, from the same text, under the same checks, and one more: wherever the editors of the translation begin a new passage or a new mishna, the map must begin a section there too. Cutting a page into moves is an editorial decision, and nobody, least of all a language model, has established that this is <em>the</em> shape of the daf; every map says so above its first line, and the page's own marks are the only joints it is not allowed to move. The kinds it sorts the moves into (a question, an answer, an objection, a proof, a dispute, a case, a story, a ruling, a question left open) are a fixed list of twelve, plain words for what the page is doing. Pages do not all have the same shape, and that is the point: after a few weeks of maps you start to see the shapes yourself.</p>
  <p>If you want real teaching, every daf page links to <a href="https://hadran.org.il" rel="noopener">Hadran</a>, <a href="https://www.myjewishlearning.com/article/daf-yomi/" rel="noopener">My Jewish Learning</a>, <a href="https://www.dafyomi.co.il/" rel="noopener">Kollel Iyun Hadaf</a>, and the <a href="https://steinsaltz.org/todays-daf/" rel="noopener">Steinsaltz Center</a>. They are the scholars. This is a door.</p>
