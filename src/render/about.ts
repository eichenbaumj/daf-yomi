...
<article class="prose">
  ...
  <p>The map is made the same way, from the same text, under the same checks, and one more: wherever the editors of the translation begin a new passage or a new mishna, the map must begin a section there too. The kinds it sorts the moves into (a question, an answer, an objection, a proof, a dispute, a case, a story, a ruling, a question left open) are a fixed list of twelve, plain words for what the page is doing. Pages do not all have the same shape, and that is the point: after a few weeks of maps you start to see the shapes yourself.</p>
